...
<head>
    ...
    <meta name="title" content="便當訂購後台系統">
    <meta name="author" content="ColorlibHQ">
    <meta name="description" content="便當訂購後台系統">
    ...
    <!-- swal -->
    <link rel="stylesheet" href="/admin/css/sweetalert2.all.min.css">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.item').change(function() {
                $('#checkAll').prop('checked', $('.item:checked').length === $('.item').length);
            });
        });
        ...
        <nav class="app-header navbar navbar-expand bg-body"> <!--begin::Container-->
            <div class="container-fluid"> <!--begin::Start Navbar Links-->
                ...
                <ul class="navbar-nav ms-auto"> <!--begin::Navbar Search-->
                    <li class="nav-item"> <p class="nav-link" > 使用者：@if(Session::has('acct')) {{ Session::get("acct") }} @endif</p> </li> <!--end::Fullscreen Toggle--> <!--begin::User Menu Dropdown-->
                    <li class="nav-item dropdown user-menu">
                        <a href="/admin/logout" class="btn btn-info btn-flat float-end">登出</a>
